...
const DepartmentMasterEdit = (props: Props) => {
    const option = [
    ...
    useEffect(() => {
        ...
        setEnteredDepartmentname(location.state.DepartmentName);
        setEnteredDepartmentshortname(location.state.DepartmentShortname);
